import{t as e}from"./shaderStore-D-XQlhUT.js";import{at as t,ct as ee,lt as te,nt as ne,rt as re,st as n,ut as ie}from"./index-BDOeq2YG.js";import{a as ae,i as oe,n as r,o as i,r as a,s as o,t as s}from"./vertexColorMixing-DxYrvkXY.js";import{n as c,r as se,t as ce}from"./logDepthDeclaration-CQC_XkZS.js";var l=`uvAttributeDeclaration`,u=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var be=[ne,re,se,le,t,o,ie,ee,ue,c,h,de,i,ae,b,fe,pe,me,ce,k,M,F,R,n,oe,te,V,he,ge,_e,a,r,ve,s,ye];for(let t of be)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var xe={name:Q,shader:$};export{xe as defaultVertexShaderWGSL};
//# sourceMappingURL=default.vertex-DLHgLB5K.js.map