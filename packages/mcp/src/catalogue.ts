      ...
      items: {
        ...
        properties: {
          ...
          rolling: {
            type: 'integer',
            description:
              'kind resample: a trailing average over this many rows, added as one column per measure named <column>_meanN. Computed over the rows in order before they are reduced to points, so it is an average of the data rather than of the picture.',
          },
          points: {
            type: 'integer',
            description:
