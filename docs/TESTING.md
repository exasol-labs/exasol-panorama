...
`export-check`, `resize-check` and `install-check` set a non-zero exit code. The
...
| Gap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Consequence                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **The probes report; they do not assert.** Only `export-check`, `resize-check` and `install-check` set an exit code. The rest print a JSON report for a human or an agent to read.                                                                                                                                                                                                                                                                                                                                                                                                                     | A probe can regress into nonsense and still "pass". Each should assert its own report and exit non-zero.                                                                                                                                                                                                                                                |
